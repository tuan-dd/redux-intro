      ...
      <WrapperBox>
         ...
         <Grid container spacing={2} p='1rem'>
            <Grid item md={6} xs={12}>
               <ProductOne product={product[0]} />
            </Grid>
            <Grid item md={6} xs={12}>
               <ProductTwo product={product[1]} />
            </Grid>
         </Grid>
      </WrapperBox>
   );
...
const CartPage = (props) => {
   ...
   return (
      <WrapperBox>
         ...
         <Grid container spacing={2} p='1rem'>
            <Grid item md={6} xs={12}>
               <CartProductOne cart={props.cart.products[0]} />
            </Grid>
            <Grid item md={6} xs={12}>
               <CartProductTwo cart={props.cart.products[1]} />
            </Grid>
            <Grid item xs={12}>
...
const CartProductOne = (props) => {
   ...
   const product = { price: props.cart.price, qty: props.cart.qty };
